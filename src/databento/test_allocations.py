# ============================================================
# DOMINIC HERE: THIS FILE IS ALMOST IDENTICAL TO THE ONE
# IN THE MENTOR MODULE, BUT HAS BEEN SLIGHTLY MODIFIED TO
...
def main(x: int):
    ...
    file_path3 = Path(f'../../data/test_allocations/fund_allocation_{x}.csv')
